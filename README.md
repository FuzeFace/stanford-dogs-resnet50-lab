...
Дообучение предобученной модели ResNet50 с оптимизатором Adam.
Дообучение предобученной модели ResNet50 с оптимизатором Averaged Adam.
Обучение модели ResNet50 с нуля с оптимизатором Adam.
Результаты
